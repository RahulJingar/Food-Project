...
import React, { useEffect, useState, useMemo } from "react";
import { useDispatch, useSelector } from "react-redux";
import { fetchRestaurants, filterRestaurants } from "../features/users/usersSlice";
import { useNavigate } from "react-router-dom";
import Navbar from "./Navbar";
import Chat from "../features/users/Chat";  // Import Chat here
...
const Dashboard = () => {
  ...
  return (
    <>
              ...
              displayedRestaurants.map((restaurant) => (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-1 text-gray-700 line-clamp-1">{restaurant.category}</p>
                  </div>
                </div>
              ))
            ) : (
      ...
      {/* Place Chat here so it is visible on Dashboard */}
      <Chat />
    </>
  );
};
